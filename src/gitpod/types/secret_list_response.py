...
__all__ = [
    ...
    "Secret",
    "SecretUnionMember0",
    "SecretUnionMember0Creator",
    "SecretUnionMember1",
    "SecretUnionMember1Creator",
    "SecretUnionMember2",
    "SecretUnionMember2Creator",
]
...
class SecretUnionMember0Creator(BaseModel):
...
class SecretUnionMember0(BaseModel):
    ...
    creator: Optional[SecretUnionMember0Creator] = None
...
class SecretUnionMember1Creator(BaseModel):
    id: Optional[str] = None
    """id is the UUID of the subject"""
...
class SecretUnionMember1(BaseModel):
    ...
    creator: Optional[SecretUnionMember1Creator] = None
    """creator is the identity of the creator of the secret"""
...
class SecretUnionMember2Creator(BaseModel):
    id: Optional[str] = None
    """id is the UUID of the subject"""
...
class SecretUnionMember2(BaseModel):
    id: Optional[str] = None
    ...
    creator: Optional[SecretUnionMember2Creator] = None
    """creator is the identity of the creator of the secret"""
...
Secret: TypeAlias = Union[SecretUnionMember0, SecretUnionMember1, SecretUnionMember2]
