...
__all__ = ["SecurityPolicy", "Metadata", "Spec", "SpecExecutables", "SpecExecutablesRule"]
...
class SpecExecutablesRule(BaseModel):
    effect: Optional[Literal["EFFECT_UNSPECIFIED", "EFFECT_ALLOW", "EFFECT_BLOCK", "EFFECT_AUDIT"]] = None
...
class SpecExecutables(BaseModel):
    """executables is the public Veto Exec GA policy surface."""

    default_effect: Optional[Literal["EFFECT_UNSPECIFIED", "EFFECT_ALLOW", "EFFECT_BLOCK", "EFFECT_AUDIT"]] = FieldInfo(
        alias="defaultEffect", default=None
    )
    """
    ...
    rules: Optional[List[SpecExecutablesRule]] = None
...
class Spec(BaseModel):
    ...
    executables: Optional[SpecExecutables] = None
    """executables is the public Veto Exec GA policy surface."""
