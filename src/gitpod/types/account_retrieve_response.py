...
__all__ = [
    ...
    "Account",
    "AccountUnionMember0",
    "AccountUnionMember0Joinable",
    "AccountUnionMember0Membership",
    "AccountUnionMember1",
    "AccountUnionMember1Joinable",
    "AccountUnionMember1Membership",
]


class AccountUnionMember0Joinable(BaseModel):
...
class AccountUnionMember0Membership(BaseModel):
    organization_id: Optional[str] = FieldInfo(alias="organizationId", default=None)
    ...
    ] = FieldInfo(alias="userRole", default=None)
    """user_role is the role the user has in the organization"""


class AccountUnionMember0(BaseModel):
    ...
    joinables: Optional[List[AccountUnionMember0Joinable]] = None

    memberships: Optional[List[AccountUnionMember0Membership]] = None
...
class AccountUnionMember1Joinable(BaseModel):
    organization_id: Optional[str] = FieldInfo(alias="organizationId", default=None)
    """organization_id is the id of the organization the user can join"""
...
class AccountUnionMember1Membership(BaseModel):
    organization_id: Optional[str] = FieldInfo(alias="organizationId", default=None)
    """organization_id is the id of the organization the user is a member of"""
...
class AccountUnionMember1(BaseModel):
    id: Optional[str] = None
    ...
    joinables: Optional[List[AccountUnionMember1Joinable]] = None

    memberships: Optional[List[AccountUnionMember1Membership]] = None
...
Account: TypeAlias = Union[AccountUnionMember0, AccountUnionMember1]
